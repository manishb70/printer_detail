                    ...
                    <table id="dataTable" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Total Quanity</th>
                                <th scope="col" class="px-4 py-3">Recieved Qty</th>
                                <!-- <th scope="col" class="px-4 py-3">Total</th> -->
                                <th scope="col" class="px-4 py-3">Created By</th>
                                <th scope="col" class="px-4 py-3">Created Date</th>
                                <th scope="col" class="px-4 py-3">PO Number Number</th>
...
<!-- <script src="./js/jquery.min.js"></script> -->
<script src="./js/grnReport.js"></script>
