...
<body
        ...
        <form class="flex justify-between  mb-4 " method="GET">
            ...
            <div class="flex items-center  mb-4  max-w-lg mx-auto">
                ...
                <div class="relative w-full mr-2">
                    ...
                    <input type="number" id="search_query" name="search_query" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Details From Database..." required />

                </div>
                <a name="search" id="searchQueryBtnManagerItem" class="inline-flex items-center cursor-pointer py-2.5 px-3 ms-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
    ...
    <div
        ...
        <table class=" text-sm mx-auto text-left border-2-black rtl:text-right text-gray-500 dark:text-gray-400">
            <thead id="" class="text-xs text-gray-700 font-sans font-bold uppercase bg-blue-300 dark:bg-gray-700 dark:text-gray-400">
