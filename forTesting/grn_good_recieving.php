            ...
            <div class="w-full xl:w-3/4 lg:w-11/12 flex">
                ...
                <div class="w-full lg:w-7/12 bg-white dark:bg-gray-700 p-5 rounded-lg lg:rounded-l-none">
                    ...
                    <form action="#" method="post" class="px-8 pt-6 pb-8 mb-4 bg-white dark:bg-gray-800 rounded">
                        <div class="mb-4">
                            <label class="block mb-2 text-sm font-bold text-gray-700 dark:text-white" for="inventoryId">
                                Inventory ID
                            </label>
                            <input name="inventory_id" class="w-full px-3 py-2 text-sm leading-tight text-gray-700 dark:text-white border rounded shadow appearance-none focus:outline-none focus:shadow-outline" id="inventoryId" type="number" placeholder="Inventory ID" required />
                        </div>
