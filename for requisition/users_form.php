                                ...
                                <tbody>
                                    ...
                                    <form action="#" method="POST">
                                        ...
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <td class=px-6 py-4">
                                                <div class="flex items-center mb-4">
                                                    <input type="checkbox" id="user_viewOnly" name="user_viewOnly" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                </div>
                                            </td>
                                            <td class=px-6 py-4">
                                        ...
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <td class=px-6 py-4">
                                                <div class="flex items-center mb-4">
                                                    <input id="user_write" type="checkbox" name="user_write" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                </div>
                                            </td>
                                            <td class=px-6 py-4">
                                        ...
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <td class=px-6 py-4">
                                                <div class="flex items-center mb-4">
                                                    <input id="adminWrite" type="checkbox" value="" name="admin_write" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                </div>
                                            </td>
                                            <td class=px-6 py-4">
                                        ...
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <td class=px-6 py-4">
                                                <div class="flex items-center mb-4">
                                                    <input id="store_manager" type="checkbox" name="store_manager" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                </div>
                                            </td>
                                            <td class=px-6 py-4">
                                                <input type="date" name="user_view_start_date" value="2000-01-01">
