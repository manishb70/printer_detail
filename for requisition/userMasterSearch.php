...
<body>
    <div id="create_section" class="mt-3 border border-gray-900 p-5 rounded-lg mx-5">
        <h1 class="text-center underline text-3xl mb-3 font-bold">Search User Form</h1>
                ...
                <div class="">
                    ...
                    <div>
                        ...
                        <input type="text" name="user_name"
                            ...
                            <button type="button"
                            class="w-20 text-white h-8 border border-blue-700 bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-xs font-bold dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-blue-800 ">Search</button>
                    </div>
                    <div class="">
                        <label
